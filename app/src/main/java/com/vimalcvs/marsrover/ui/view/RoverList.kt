...
import com.vimalcvs.marsrover.R
import com.vimalcvs.marsrover.model.roverUiModelList
...
@Composable
fun RoverList(onClick: (roverName: String) -> Unit) {
    Surface(
        color = MaterialTheme.colorScheme.background,
        modifier = Modifier.fillMaxSize()
    ) {
        LazyColumn {
            items(count = roverUiModelList.size) { index ->
                Rover(
